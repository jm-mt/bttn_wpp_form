...
(function() {
    ...
    const initWidget = () => {
        ...
        const state = {
            ...
            isProcessing: false,
            privacyAccepted: false,
            popupBlocked: false,  // Flag se popup foi bloqueado
            timers: {
        ...
        // Se popup for bloqueado, mostra mensagem pedindo clique do usuario
        const goToWhatsApp = (type = 'app') => {
            ...
            if (!newWindow || newWindow.closed || typeof newWindow.closed === 'undefined') {
                log('Popup blocked - showing manual redirect message');
                state.popupBlocked = true;
                showPopupBlockedMessage(url, type);
            } else {
                log('WhatsApp opened in new tab');
            }
        };

        // Mostra mensagem quando popup e bloqueado pedindo clique do usuario
        const showPopupBlockedMessage = (url, type) => {
            const messageEl = document.createElement('div');
            messageEl.className = 'wwl-message wwl-bot wwl-popup-blocked-msg';
            messageEl.innerHTML = `
            ...
            log('Popup blocked message shown');
        };
        ...
        const showWhatsAppChoiceMessage = () => {
            ...
            // Cria mensagem com links (nao buttons) para garantir abertura em nova aba
            const messageEl = document.createElement('div');
            ...
            // Event listeners nos links (apenas para atualizar visual e parar timer)
            // Permite cliques multiplos com cooldown de 1.5s entre cada
            ...
            buttons.forEach(btn => {
                btn.addEventListener('click', (e) => {
                    ...
                    // NAO previne default - deixa o link abrir normalmente em nova aba
